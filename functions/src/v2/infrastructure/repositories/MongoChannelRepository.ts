// src/v2/infrastructure/repositories/MongoChannelRepository.ts

import { Channel, ChannelProps } from '@v2/domain/entities/Channel';
import { ChannelId } from '@v2/domain/value-objects/ChannelId';
import {
  IChannelRepository,
  ChannelFilters,
} from '@v2/domain/repositories/IChannelRepository';
