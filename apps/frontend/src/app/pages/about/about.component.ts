  ...
  template: `
    <div class="min-h-screen bg-[var(--portal-bg)] text-[var(--portal-text)]">
      ...
      <div class="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <!-- Mission -->
        <section class="mb-16">
          <h2 class="text-2xl font-bold text-[var(--portal-text)] mb-4">Nuestra misión</h2>
          <p class="text-[var(--portal-text-soft)] leading-8">
        ...
        <!-- What We Offer -->
        <section class="mb-16">
          <h2 class="text-2xl font-bold text-[var(--portal-text)] mb-6">Qué ofrecemos</h2>
          <div class="grid md:grid-cols-2 gap-6">
            <div class="rounded-2xl border border-[var(--portal-border)] bg-[var(--portal-bg-deep)] p-6">
              <h3 class="text-lg font-semibold text-[var(--portal-text)] mb-2">Programación TV en directo</h3>
              <p class="text-sm text-[var(--portal-text-soft)]">Parrilla completa de todos los canales de la TDT española y canales autonómicos, actualizada en tiempo real con horarios, sinopsis y categorías.</p>
            </div>
            <div class="rounded-2xl border border-[var(--portal-border)] bg-[var(--portal-bg-deep)] p-6">
              <h3 class="text-lg font-semibold text-[var(--portal-text)] mb-2">Catálogo de streaming</h3>
              <p class="text-sm text-[var(--portal-text-soft)]">Explora el catálogo completo de Netflix, HBO Max, Disney+, Amazon Prime Video, Movistar+ y más. Filtra por género, plataforma y disponibilidad.</p>
            </div>
            <div class="rounded-2xl border border-[var(--portal-border)] bg-[var(--portal-bg-deep)] p-6">
              <h3 class="text-lg font-semibold text-[var(--portal-text)] mb-2">Recomendaciones personalizadas</h3>
              <p class="text-sm text-[var(--portal-text-soft)]">Algoritmo de recomendación basado en tus gustos, historial y valoraciones. Descubre contenido nuevo que realmente te interesa.</p>
            </div>
            <div class="rounded-2xl border border-[var(--portal-border)] bg-[var(--portal-bg-deep)] p-6">
              <h3 class="text-lg font-semibold text-[var(--portal-text)] mb-2">Editorial y rankings</h3>
              <p class="text-sm text-[var(--portal-text-soft)]">Artículos, reseñas, rankings y análisis sobre cine, series y anime, conectados con el resto de la app y escritos por expertos en entretenimiento audiovisual.</p>
            </div>
          </div>
        </section>
        ...
        <!-- Technology -->
        <section class="mb-16">
          <h2 class="text-2xl font-bold text-[var(--portal-text)] mb-4">Tecnología</h2>
          <p class="text-[var(--portal-text-soft)] leading-8">
        ...
        <!-- Contact -->
        <section class="mb-16">
          <h2 class="text-2xl font-bold text-[var(--portal-text)] mb-4">Contacto</h2>
          <div class="rounded-2xl border border-[var(--portal-border)] bg-[var(--portal-bg-deep)] p-6 space-y-3">
            <p class="text-sm text-[var(--portal-text-soft)]"><span class="text-[var(--portal-text-muted)]">Soporte:</span> soporte&#64;tecnoriasl.com</p>
            <p class="text-sm text-[var(--portal-text-soft)]"><span class="text-[var(--portal-text-muted)]">Legal:</span> legal&#64;tecnoriasl.com</p>
            <p class="text-sm text-[var(--portal-text-soft)]"><span class="text-[var(--portal-text-muted)]">Prensa:</span> prensa&#64;tecnoriasl.com</p>
          </div>
        </section>
