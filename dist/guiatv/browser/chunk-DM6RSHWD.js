...
function AutocompleteComponent_ng_container_8_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "mat-option", 10);
    \u0275\u0275listener("onSelectionChange", function AutocompleteComponent_ng_container_8_ng_container_1_Template_mat_option_onSelectionChange_1_listener($event) {
      const option_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(($event.source == null ? null : $event.source.selected) && ctx_r2.navigateTo(option_r2));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("src", (option_r2 == null ? null : option_r2.channel == null ? null : option_r2.channel.name) ? "https://wsrv.nl/?url=https://raw.githubusercontent.com/davidmuma/picons_dobleM/master/icon/" + option_r2.channel.name + ".png" : (option_r2 == null ? null : option_r2.icon) ? "https://wsrv.nl/?url=" + option_r2.icon : "", \u0275\u0275sanitizeUrl)("alt", (option_r2 == null ? null : option_r2.channel == null ? null : option_r2.channel.name) || (option_r2 == null ? null : option_r2.title == null ? null : option_r2.title.value) || "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", (option_r2 == null ? null : option_r2.channel == null ? null : option_r2.channel.name) || (option_r2 == null ? null : option_r2.title == null ? null : option_r2.title.value), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", (option_r2 == null ? null : option_r2.start) ? \u0275\u0275pipeBind2(9, 5, option_r2.start, "shortTime") + " - " + \u0275\u0275pipeBind2(10, 8, option_r2.stop, "shortTime") : (option_r2 == null ? null : option_r2.channel == null ? null : option_r2.channel.name) || "", " ");
  }
}
function AutocompleteComponent_ng_container_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, AutocompleteComponent_ng_container_8_ng_container_1_Template, 11, 11, "ng-container", 9);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
var _AutocompleteComponent = class _AutocompleteComponent {
  ...
  ngOnInit() {
    this.filteredData = this.dataInput.valueChanges.pipe(startWith(""), debounceTime(150), distinctUntilChanged(), map((value) => {
      const str = typeof value === "string" ? value : value?.toString() || "";
      return this._filter(str);
    }));
    this.tvSvc.getProgramsAndChannels().subscribe((data) => {
      this.data = data || [];
    });
  }
  _filter(value) {
    ...
    const channels = this.data.filter((option) => option?.channel?.name?.toLowerCase().includes(filterValue));
    const programs = this.data.flatMap((option) => option?.programs?.filter((program) => program?.title?.value ? program.title.value.toLowerCase().includes(filterValue) : false) || []);
  ...
  navigateTo(data) {
    ...
    const looksLikeMovie = !!(data?.poster || data?.rating || data?.releaseDate);
    if (looksLikeMovie) {
...
_AutocompleteComponent.\u0275fac = function AutocompleteComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _AutocompleteComponent)(\u0275\u0275directiveInject(TvGuideService), \u0275\u0275directiveInject(Router));
};
_AutocompleteComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AutocompleteComponent, selectors: [["app-autocomplete"]], decls: 10, vars: 6, consts: [["auto", "matAutocomplete"], [1, "relative", "items-center", "content-center", "flex", "w-full"], [1, "text-gray-400", "absolute", "left-4", "cursor-pointer"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", "stroke", "currentColor", 1, "h-4", "w-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"], [1, "relative"], ["type", "text", "placeholder", "Buscar Pelicula, Serie. ..", "matInput", "", 1, "text-xs", "ring-1", "bg-transparent", "ring-gray-200", "dark:ring-zinc-600", "focus:ring-red-300", "pl-10", "pr-5", "text-gray-600", "dark:text-white", "py-3", "rounded-full", "w-full", "outline-none", "focus:ring-1", 3, "formControl", "matAutocomplete"], ["autoActiveFirstOption", "", 3, "displayWith"], [4, "ngIf"], [4, "ngFor", "ngForOf"], [1, "w-full", "bg-white", "hover:bg-slate-50", "z-30", 3, "onSelectionChange", "value"], [1, "flex", "justify-between", "content-center"], [1, "w-10", "h-10", "rounded-full", 3, "src", "alt"], [1, "flex", "flex-col", "ml-2"], [1, "text-xs", "font-semibold", "text-gray-600", "dark:text-white"], [1, "text-xs", "text-gray-400", "dark:text-gray-300"]], template: function AutocompleteComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(5, "input", 6);
    \u0275\u0275elementStart(6, "mat-autocomplete", 7, 0);
    \u0275\u0275template(8, AutocompleteComponent_ng_container_8_Template, 2, 1, "ng-container", 8);
    \u0275\u0275pipe(9, "async");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const auto_r5 = \u0275\u0275reference(7);
    \u0275\u0275advance(5);
    \u0275\u0275property("formControl", ctx.dataInput)("matAutocomplete", auto_r5);
    \u0275\u0275advance();
    \u0275\u0275property("displayWith", ctx.displayFn.bind(ctx));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", \u0275\u0275pipeBind1(9, 4, ctx.filteredData));
  }
}, dependencies: [
  CommonModule,
  NgForOf,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AutocompleteComponent, [{
    ...
    args: [{ selector: "app-autocomplete", standalone: true, imports: [
      ...
      MatFormFieldModule,
      MatOptionModule
    ], template: `<div class="relative items-center content-center flex w-full">\r
  <span class="text-gray-400 absolute left-4 cursor-pointer">\r
    <svg\r
    ...
    >\r
      <path\r
        ...
        stroke-width="2"\r
        d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"\r
      ></path>\r
    </svg>\r
  </span>\r
  <div class="relative">\r
    <input\r
      type="text"\r
      [formControl]="dataInput"\r
      [matAutocomplete]="auto"\r
      class="text-xs ring-1 bg-transparent ring-gray-200 dark:ring-zinc-600 focus:ring-red-300 pl-10 pr-5 text-gray-600 dark:text-white py-3 rounded-full w-full outline-none focus:ring-1"\r
      placeholder="Buscar Pelicula, Serie. .."\r
      matInput\r
    />\r
    <mat-autocomplete\r
      autoActiveFirstOption\r
      #auto="matAutocomplete"\r
      [displayWith]="displayFn.bind(this)"\r
    >\r
      <ng-container *ngIf="filteredData | async as options">\r
        <ng-container *ngFor="let option of options">\r
          <mat-option\r
            class="w-full bg-white hover:bg-slate-50 z-30"\r
            [value]="option"\r
            (onSelectionChange)="$event.source?.selected && navigateTo(option)"\r
          >\r
            <div class="flex justify-between content-center">\r
              <img\r
                class="w-10 h-10 rounded-full"\r
                [src]="\r
                  option?.channel?.name\r
                    ? 'https://wsrv.nl/?url=https://raw.githubusercontent.com/davidmuma/picons_dobleM/master/icon/' +\r
                      option.channel.name +\r
                      '.png'\r
                    : option?.icon\r
                    ? 'https://wsrv.nl/?url=' + option.icon\r
                    : ''\r
                "\r
                [alt]="option?.channel?.name || option?.title?.value || ''"\r
              />\r
              <div class="flex flex-col ml-2">\r
                <span\r
                  class="text-xs font-semibold text-gray-600 dark:text-white"\r
                >\r
                  {{ option?.channel?.name || option?.title?.value }}\r
                </span>\r
                <span class="text-xs text-gray-400 dark:text-gray-300">\r
                  {{\r
                    option?.start\r
                      ? (option.start | date : "shortTime") +\r
                        " - " +\r
                        (option.stop | date : "shortTime")\r
                      : option?.channel?.name || ""\r
                  }}\r
                </span>\r
              </div>\r
...
`, styles: ["/* src/app/components/autocomplete/autocomplete.component.scss */\n::ng-deep .cdk-overlay-pane {\n  position: fixed !important;\n  z-index: 5000 !important;\n  background-color: white !important;\n  pointer-events: auto !important;\n}\n::ng-deep .cdk-overlay-container {\n  position: fixed !important;\n  inset: 0 !important;\n  z-index: 5000 !important;\n  pointer-events: none !important;\n}\n:host {\n  position: fixed;\n  top: 1rem;\n  left: 50%;\n  transform: translateX(-50%);\n  width: calc(100% - 2rem);\n  max-width: 640px;\n  z-index: 6000;\n  pointer-events: auto;\n  display: block;\n}\n::ng-deep .mat-mdc-autocomplete-panel {\n  width: 100% !important;\n  max-height: 300px !important;\n  overflow: auto !important;\n  padding: 0 !important;\n  border-radius: 0 !important;\n  border: 1px solid #ccc !important;\n  box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2) !important;\n  background-color: white !important;\n}\n::ng-deep .mat-mdc-option:hover {\n  background-color: #dc2626 !important;\n  color: white !important;\n}\n::ng-deep .mat-mdc-option.mat-active {\n  background-color: #dc2626 !important;\n  color: white !important;\n}\n/*# sourceMappingURL=autocomplete.component.css.map */\n"] }]
  }], () => [{ type: TvGuideService }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AutocompleteComponent, { className: "AutocompleteComponent", filePath: "src/app/components/autocomplete/autocomplete.component.ts", lineNumber: 33 });
})();
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-DM6RSHWD.js.map
