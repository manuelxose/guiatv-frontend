...
exports.swaggerSpec = exports.getSwaggerSpec = void 0;
...
const swaggerDefinition = {
    ...
    info: {
        title: 'Guía TV API',
        version: app_config_1.appConfig.apiVersion,
        description: 'API REST para consulta de programación de televisión en España',
        contact: {
            name: 'API Support',
    ...
    tags: [
        ...
        {
            name: 'SSR',
            description: 'Endpoints optimizados para Server Side Rendering',
        },
    ],
    components: {
        schemas: {
            ...
            Program: {
                ...
                properties: {
                    ...
                    image: {
                        ...
                        example: 'https://storage.googleapis.com/guia-tv/programs/telediario.jpg',
                    },
                    genre: {
                        type: 'string',
        ...
        parameters: {
            DateParam: {
                ...
                in: 'path',
                required: true,
                description: 'Fecha en formato YYYYMMDD o alias (today, tomorrow, after_tomorrow)',
                schema: {
                    type: 'string',
                    example: 'today',
                },
...
const getSwaggerSpec = () => {
    if (!cachedSpec) {
        cachedSpec = (0, swagger_jsdoc_1.default)(options);
    }
    return cachedSpec;
};
exports.getSwaggerSpec = getSwaggerSpec;
exports.swaggerSpec = new Proxy({}, {
    get: (_target, prop) => {
        const spec = (0, exports.getSwaggerSpec)();
        return spec[prop];
    }
});
